                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'jmtznv5r' /* Enter your credentials to acce... */,
                              ),
                                                      ...
                                                      onPressed: () async {
                                                        ...
                                                        if (_model
                                                          ...
                                                          if ((_model
                                                                  ...
                                                                  ?.succeeded ??
                                                              true)) {
                                                            _model.loginResponseAfterSignUp =
                                                                await GlobalGroup
                                                                    .loginCall
                                                                    .call(
                                                              user: _model
                                                              ...
                                                              setState(() {
                                                                ...
                                                                FFAppState()
                                                                    ...
                                                                    GlobalGroup
                                                                        .loginCall
                                                                        .token(
                                                                          (_model.loginResponseAfterSignUp?.jsonBody ??
                                                                              ''),
                                                                        )
                                                                        .toString();
                                                              });
