                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                _model.projectResponse =
                                    await UserGroup.createProjectCall.call(
                                ...
                                if ((_model.projectResponse?.succeeded ??
                                    true)) {
                                  FFAppState().addToProjects(
                                      UserGroup.createProjectCall.project(
                                    (_model.projectResponse?.jsonBody ?? ''),
                                  ));
                                  context.safePop();
                                } else {
                                  setState(() {
                                    FFAppState().addToProjects(getJsonField(
                                      functions.getProject(
                                          _model.projectNameController.text,
                                          _model.descriptionController.text,
                                          FFAppState().MobileID),
                                      r'''$''',
