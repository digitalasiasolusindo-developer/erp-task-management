                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'qcgnuqsf' /* Assign to me */,
                                    ),
                                    style:
                                        FlutterFlowTheme.of(context).bodyMedium,
                                  ),
                                  Switch(
                                    value: _model.assignToMeValue ??= true,
                                    onChanged: (newValue) async {
                                      setState(() =>
                                          _model.assignToMeValue = newValue!);
                                    },
                                  ),
                                ],
                              ),
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            _model.taskResponse =
                                await UserGroup.createTaskCall.call(
                              token: FFAppState().Token,
                              project: getJsonField(
                                widget.project,
                                r'''$.name''',
                              ).toString(),
                              subject: _model.taskNameController.text,
                              description: _model.descriptionController.text,
                              expEndDate: _model.datePicked?.toString(),
                              expectedEndTime: dateTimeFormat(
                                'Hm',
                                _model.datePicked,
                                locale:
                                    FFLocalizations.of(context).languageCode,
                              ),
                              mobileId: FFAppState().MobileID,
                              assignToMe: _model.assignToMeValue! ? 1 : 0,
                            );
                            if ((_model.taskResponse?.succeeded ?? true)) {
                              FFAppState().Tasks = getJsonField(
                                functions.getTaskAdded(
                                    FFAppState().Tasks,
                                    UserGroup.createTaskCall.task(
                                      (_model.taskResponse?.jsonBody ?? ''),
                                    )),
                                r'''$''',
                              );
                            } else {
