...
class ModalTaskDetailsWidget extends StatefulWidget {
  const ModalTaskDetailsWidget({Key? key}) : super(key: key);
                                    ...
                                    children: [
                                          ...
                                          Expanded(
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '120z5oik' /* Design Template Screens */,
                                              ),
                                              style:
                                      ...
                                      AutoSizeText(
                                        FFLocalizations.of(context).getText(
                                          'mosx0yk6' /* Create template screen for tas... */,
                                        ),
                                        maxLines: 3,
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  '0802fu3w' /* albert@companyname.com */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodySmall,
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              '5hvy6ssi' /* Your welcome. Push notificatio... */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .labelSmall,
