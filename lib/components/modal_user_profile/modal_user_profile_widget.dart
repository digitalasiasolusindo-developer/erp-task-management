...
class ModalUserProfileWidget extends StatefulWidget {
  const ModalUserProfileWidget({Key? key}) : super(key: key);
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(
                          FFLocalizations.of(context).getText(
                            '74ak1hrm' /* Lorem ipsum dolor sit amet, co... */,
                          ),
